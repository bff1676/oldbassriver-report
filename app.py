...
st.markdown("<div class='obr-hero'><div class='obr-kicker'>41°40′N 70°11′W · Bass River · Cape Cod</div><div class='obr-title'>Old Bass River Daily Report Editor</div><div class='obr-sub'>Update the daily fishing notes in a simple form and generate the website report with a live weather map in the preview.</div></div>", unsafe_allow_html=True)
...
with left:
    ...
    st.markdown("<div class='obr-note'><strong>Tip:</strong> The automated parts are conditions, tides, news, and the live weather map. What matters most for readers is still your real same-day local bite intel and boating context.</div>", unsafe_allow_html=True)
