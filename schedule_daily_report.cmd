...
set MESSAGE=In the oldbassriver-report workspace, run "%PYTHON_EXE%" "%GENERATOR%" and send the generated markdown daily fishing report to the user. Mention that the matching HTML file is ready in output\daily_report.html for HubSpot.
